  ...
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius='15px' padding= '20px' bgcolor='#fcfcfc'>
        ...
        >
          <FormControl>
            <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color:'#11142d' }}>Enter Product Name</FormHelperText>
            <TextField
            fullWidth
            required
            id='outlined-basic'
          ...
          <FormControl>
            <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color:'#11142d' }}>Enter Product Description
            </FormHelperText>
          <TextareaAutosize 
            minRows={5}
            required
          ...
          <Stack direction='row' gap={4}>
            ...
            <FormControl>
            <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color:'#11142d' }}>
              Enter Product Price</FormHelperText>
            <TextField
            fullWidth
            required
            id='outlined-basic'
          ...
          <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            <Stack direction="row" gap={2}>
              <Typography color="#11142d" fontSize={16} fontWeight={500} my="10px">Image</Typography>
              <Button component="label" sx={{width:'fit-content', color: '#2ed489',textTransform:'capitalize', fontSize: 16 }}>
                Upload * 
                <input
                hidden
                accept='image/'
